...
### Результат
- Получено ожидаемое ускорение на сетках, размером от **400-500**. Если в качестве начальных условиях учитывать затраты на синхронизацию, то получено теоретически ожидаемое замедление на сетках размером до **300**.
- Выявлена некоторая закономерность - необходимо найти "баланс" между размером сетки и размером блока. По результатам эксперимента была построена таблица наиболее отпимальных размеров блоков для разных размеров сетки.
